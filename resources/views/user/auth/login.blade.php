...
<head>
    ...
    <meta name="description" content="Iroid">
    <meta name="author" content="Iroid">
    <meta name="keywords" content="Iroid">

    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/images/brand/favicon.png')}}" />

    <!-- TITLE -->
    <title>Iroid - Login</title>
            ...
            <div class="">
                ...
                <div class="container-login100">
                    <div class="wrap-login100 p-6">
                        ...
                        <form class="login100-form validate-form" method="post" action="{{route('user.post_login')}}">
                            {{ csrf_field() }}
